...
## この課題を通して学んだこと
 ...
 Websocketでの通信。
## 工夫した点
 チャットに接続している人数を表示するようにしたところ。
## 苦労した点
 cssが苦手でした。  
## 追加した機能
 ログインユーザのメッセージと、その他のメッセージを左右に分けて表示するようにしました。  
 右上に現在の接続人数と、接続しているユーザー名を表示するようにしました。  
 リロード時にサーバー側に保持されているメッセージをクライアント側で取得できるようにしました。
## その他
　1か月間でVueでの開発のことを多く学べました。ありがとうございました。
